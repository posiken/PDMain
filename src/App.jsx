...
.type-btn{padding:16px 8px;border-radius:9px;border:1.5px solid #1d2d44;background:#0d1322;color:#6b8299;
  cursor:pointer;transition:transform .15s,box-shadow .15s;display:flex;flex-direction:column;align-items:center;gap:5px;}
.type-btn:hover:not(:disabled){border-color:#263a52;color:#8097b1;transform:translateY(-1px);}
