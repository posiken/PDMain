...
.type-btn.ghp-active  {border-color:#38bdf8;background:rgba(56,189,248,.18); color:#38bdf8;box-shadow:0 0 8px rgba(56,189,248,.55),0 0 20px rgba(56,189,248,.15);}
.type-btn.lawn-active {border-color:#4ade80;background:rgba(74,222,128,.18); color:#4ade80;box-shadow:0 0 8px rgba(74,222,128,.55),0 0 20px rgba(74,222,128,.15);}
.type-btn.tmte-active {border-color:#fb923c;background:rgba(251,146,60,.18);  color:#fb923c;box-shadow:0 0 8px rgba(251,146,60,.55), 0 0 20px rgba(251,146,60,.15);}
.type-btn.spvr-active {border-color:#c084fc;background:rgba(192,132,252,.18);color:#c084fc;box-shadow:0 0 8px rgba(192,132,252,.55),0 0 20px rgba(192,132,252,.15);}
.type-btn.tc-active   {border-color:#f87171;background:rgba(248,113,113,.18);color:#f87171;box-shadow:0 0 8px rgba(248,113,113,.55),0 0 20px rgba(248,113,113,.15);}
.type-btn.ghp-active:active  {border-color:#38bdf8;background:rgba(56,189,248,.18); color:#38bdf8;box-shadow:0 0 8px rgba(56,189,248,.55),0 0 20px rgba(56,189,248,.15);}
.type-btn.lawn-active:active {border-color:#4ade80;background:rgba(74,222,128,.18); color:#4ade80;box-shadow:0 0 8px rgba(74,222,128,.55),0 0 20px rgba(74,222,128,.15);}
.type-btn.tmte-active:active {border-color:#fb923c;background:rgba(251,146,60,.18);  color:#fb923c;box-shadow:0 0 8px rgba(251,146,60,.55), 0 0 20px rgba(251,146,60,.15);}
.type-btn.spvr-active:active {border-color:#c084fc;background:rgba(192,132,252,.18);color:#c084fc;box-shadow:0 0 8px rgba(192,132,252,.55),0 0 20px rgba(192,132,252,.15);}
.type-btn.tc-active:active   {border-color:#f87171;background:rgba(248,113,113,.18);color:#f87171;box-shadow:0 0 8px rgba(248,113,113,.55),0 0 20px rgba(248,113,113,.15);}
.type-btn.comm-active {border-color:#22d3ee;background:rgba(34,211,238,.18); color:#22d3ee;box-shadow:0 0 8px rgba(34,211,238,.55), 0 0 20px rgba(34,211,238,.15);}
.type-btn.mosq-active {border-color:#a3e635;background:rgba(163,230,53,.18);  color:#a3e635;box-shadow:0 0 8px rgba(163,230,53,.55),  0 0 20px rgba(163,230,53,.15);}
.type-btn.excl-active {border-color:#fbbf24;background:rgba(251,191,36,.18);  color:#fbbf24;box-shadow:0 0 8px rgba(251,191,36,.55),  0 0 20px rgba(251,191,36,.15);}
.type-btn.wild-active {border-color:#e879f9;background:rgba(232,121,249,.18); color:#e879f9;box-shadow:0 0 8px rgba(232,121,249,.55), 0 0 20px rgba(232,121,249,.15);}
.type-btn.tap-active  {border-color:#f472b6;background:rgba(244,114,182,.18); color:#f472b6;box-shadow:0 0 8px rgba(244,114,182,.55), 0 0 20px rgba(244,114,182,.15);}
.type-btn.pret-active {border-color:#818cf8;background:rgba(129,140,248,.18); color:#818cf8;box-shadow:0 0 8px rgba(129,140,248,.55), 0 0 20px rgba(129,140,248,.15);}
.type-btn.post-active {border-color:#34d399;background:rgba(52,211,153,.18);  color:#34d399;box-shadow:0 0 8px rgba(52,211,153,.55),  0 0 20px rgba(52,211,153,.15);}
.type-btn.smrt-active {border-color:#f0abfc;background:rgba(240,171,252,.18); color:#f0abfc;box-shadow:0 0 8px rgba(240,171,252,.55), 0 0 20px rgba(240,171,252,.15);}
.type-btn.sent-active {border-color:#67e8f9;background:rgba(103,232,249,.18); color:#67e8f9;box-shadow:0 0 8px rgba(103,232,249,.55), 0 0 20px rgba(103,232,249,.15);}
.type-btn.bbug-active {border-color:#fb7185;background:rgba(251,113,133,.18); color:#fb7185;box-shadow:0 0 8px rgba(251,113,133,.55), 0 0 20px rgba(251,113,133,.15);}
.type-btn.finsp-active{border-color:#94a3b8;background:rgba(148,163,184,.18); color:#94a3b8;box-shadow:0 0 8px rgba(148,163,184,.55), 0 0 20px rgba(148,163,184,.15);}
.type-btn.comm-active:active {border-color:#22d3ee;background:rgba(34,211,238,.18); color:#22d3ee;box-shadow:0 0 8px rgba(34,211,238,.55), 0 0 20px rgba(34,211,238,.15);}
.type-btn.mosq-active:active {border-color:#a3e635;background:rgba(163,230,53,.18);  color:#a3e635;box-shadow:0 0 8px rgba(163,230,53,.55),  0 0 20px rgba(163,230,53,.15);}
.type-btn.excl-active:active {border-color:#fbbf24;background:rgba(251,191,36,.18);  color:#fbbf24;box-shadow:0 0 8px rgba(251,191,36,.55),  0 0 20px rgba(251,191,36,.15);}
.type-btn.wild-active:active {border-color:#e879f9;background:rgba(232,121,249,.18); color:#e879f9;box-shadow:0 0 8px rgba(232,121,249,.55), 0 0 20px rgba(232,121,249,.15);}
.type-btn.tap-active:active  {border-color:#f472b6;background:rgba(244,114,182,.18); color:#f472b6;box-shadow:0 0 8px rgba(244,114,182,.55), 0 0 20px rgba(244,114,182,.15);}
.type-btn.pret-active:active {border-color:#818cf8;background:rgba(129,140,248,.18); color:#818cf8;box-shadow:0 0 8px rgba(129,140,248,.55), 0 0 20px rgba(129,140,248,.15);}
.type-btn.post-active:active {border-color:#34d399;background:rgba(52,211,153,.18);  color:#34d399;box-shadow:0 0 8px rgba(52,211,153,.55),  0 0 20px rgba(52,211,153,.15);}
.type-btn.smrt-active:active {border-color:#f0abfc;background:rgba(240,171,252,.18); color:#f0abfc;box-shadow:0 0 8px rgba(240,171,252,.55), 0 0 20px rgba(240,171,252,.15);}
.type-btn.sent-active:active {border-color:#67e8f9;background:rgba(103,232,249,.18); color:#67e8f9;box-shadow:0 0 8px rgba(103,232,249,.55), 0 0 20px rgba(103,232,249,.15);}
.type-btn.bbug-active:active {border-color:#fb7185;background:rgba(251,113,133,.18); color:#fb7185;box-shadow:0 0 8px rgba(251,113,133,.55), 0 0 20px rgba(251,113,133,.15);}
.type-btn.finsp-active:active{border-color:#94a3b8;background:rgba(148,163,184,.18); color:#94a3b8;box-shadow:0 0 8px rgba(148,163,184,.55), 0 0 20px rgba(148,163,184,.15);}
...
.type-toggle{padding:10px 6px;border-radius:7px;border:1.5px solid #1a2a3d;background:#090e1a;
  color:#64748b;cursor:pointer;transition:all .18s;font-family:'Barlow Condensed',sans-serif;font-size:15px;font-weight:700;letter-spacing:.04em;text-align:center;}
...
.tt-tc.on   {border-color:rgba(248,113,113,.5);background:rgba(248,113,113,.1);color:#f87171;}
.tt-comm.on {border-color:rgba(34,211,238,.5); background:rgba(34,211,238,.1); color:#22d3ee;}
.tt-mosq.on {border-color:rgba(163,230,53,.5);  background:rgba(163,230,53,.1);  color:#a3e635;}
.tt-excl.on {border-color:rgba(251,191,36,.5);  background:rgba(251,191,36,.1);  color:#fbbf24;}
.tt-wild.on {border-color:rgba(232,121,249,.5); background:rgba(232,121,249,.1); color:#e879f9;}
.tt-tap.on  {border-color:rgba(244,114,182,.5); background:rgba(244,114,182,.1); color:#f472b6;}
.tt-pret.on {border-color:rgba(129,140,248,.5); background:rgba(129,140,248,.1); color:#818cf8;}
.tt-post.on {border-color:rgba(52,211,153,.5);  background:rgba(52,211,153,.1);  color:#34d399;}
.tt-smrt.on {border-color:rgba(240,171,252,.5); background:rgba(240,171,252,.1); color:#f0abfc;}
.tt-sent.on {border-color:rgba(103,232,249,.5); background:rgba(103,232,249,.1); color:#67e8f9;}
.tt-bbug.on {border-color:rgba(251,113,133,.5); background:rgba(251,113,133,.1); color:#fb7185;}
.tt-finsp.on{border-color:rgba(148,163,184,.5); background:rgba(148,163,184,.1); color:#94a3b8;}
    ...
    <div className="tech-card" style={{animationDelay:`${index*55}ms`}}>
      ...
      <div style={{flex:1,minWidth:0}}>
        ...
        <div className="zip-tags">
          <span className="zip-tag zip-hl">{highlightZip}</span>
          {extraZips>0 && <span className="zip-more">+{extraZips} more</span>}
        </div>
      </div>
    </div>
  );
...
function SearchView({ techs, zipInput, setZipInput, result, setResult }) {
  const [selTypes, setSelTypes] = useState([]); // multiple types can be selected
  const zipReady = zipInput.length === 5;

  // Toggle a type on/off; auto-search fires via the effect below
  ...
  // Re-run search whenever zip or selected types change
  useEffect(()=>{
    if (!zipReady || selTypes.length===0) { setResult(null); return; }
    const zip = zipInput.trim();
    const matches = techs
      .filter(t => {
        const techTypes = t.types || [];
        const zipMatch  = t.zipCodes.includes(zip);
        const typeMatch = selTypes.every(st => techTypes.includes(st));
        // Supervisors only appear when Supervisor is explicitly selected
        const supervisorOk = techTypes.includes("Supervisor") ? selTypes.includes("Supervisor") : true;
        return zipMatch && typeMatch && supervisorOk;
      })
      .sort((a,b)=>(STATUS_ORDER[a.status]??3)-(STATUS_ORDER[b.status]??3));
    setResult({ zip, types:[...selTypes], matches });
  }, [selTypes, zipInput, techs]);
  ...
  return (
    <>
      <div className="search-hero">
        ...
        <p className="hero-sub">Enter a ZIP code, then select one or more service types.</p>
        ...
        <div className="type-section">
          ...
          <div className="type-grid" style={{gridTemplateColumns:"repeat(4,1fr)"}}>
            {["GHP","Lawn","Termite","Mosquito"].map(type=>(
              <button key={type} className={`type-btn${selTypes.includes(type)?` ${TYPE_ACTIVE_CLASS[type]}`:""}`}
                disabled={!zipReady} onClick={()=>toggleType(type)}>
      ...
      {result ? (
          ...
          {result.matches.length===0 ? (
            <div className="empty-state">
              ...
              <div className="empty-text">
                ...
                &nbsp;are assigned to ZIP&nbsp;
                <strong style={{color:"#f59e0b"}}>{result.zip}</strong>.
              </div>
            </div>
        ...
        <div style={{textAlign:"center",marginTop:48,color:"#2a3f58"}}>
          ...
          <div style={{fontFamily:"'DM Mono',monospace",fontSize:11,letterSpacing:"0.13em",textTransform:"uppercase"}}>
            {zipReady ? "Select a service type above" : "Start by entering a zip code"}
          </div>
        </div>
      )}
