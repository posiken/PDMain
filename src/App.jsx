...
// ─── CONFIG ───────────────────────────────────────────────────────────────────
const STATUS_ORDER = { available: 0, "on-call": 1, "in-training": 2, "off-duty": 3 };
      ...
      <div className="search-hero">
        ...
        <div className="disclaimer">
          ...
          <div className="disclaimer-text">
            When scheduling via PestPac, drive times, tech duties, and standard procedures apply.
            If you are unsure about scheduling the correct technician, you must contact a router or supervisor for assistance.
            <br/><br/>
            <strong>This app is for personal use only.</strong> It is not officially affiliated with Turner Pest Control, and is privately maintained during personal hours.
          </div>
        </div>
      </div>
...
function TechModal({ mode, tech, allTechs, onSave, onClose }) {
  const blank = {name:"",phone:"",status:"available",branch:"",types:[],zipCodes:[],notes:""};
  const [form,     setForm]     = useState(mode==="edit"?{...tech,types:tech.types||[],branch:tech.branch||""}:blank);
